...
#define CLKS_KEY_CTRL_A ((char)0x17)
#define CLKS_KEY_CTRL_C ((char)0x18)
#define CLKS_KEY_CTRL_E ((char)0x19)
#define CLKS_KEY_CTRL_K ((char)0x1AU)
#define CLKS_KEY_CTRL_L ((char)0x1BU)
#define CLKS_KEY_CTRL_U ((char)0x1CU)
#define CLKS_KEY_CTRL_W ((char)0x1DU)
#define CLKS_KEY_CTRL_D ((char)0x1EU)
