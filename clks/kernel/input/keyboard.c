...
static clks_bool clks_keyboard_try_emit_ctrl_shortcut(u8 code, u32 tty_index) {
    ...
    switch (code) {
    case 0x01U:
        shortcut = CLKS_KEY_CTRL_A;
        break;
    case 0x03U:
        shortcut = CLKS_KEY_CTRL_C;
        break;
    case 0x05U:
        shortcut = CLKS_KEY_CTRL_E;
        break;
    case 0x0BU:
        shortcut = CLKS_KEY_CTRL_K;
        break;
    case 0x0CU:
        shortcut = CLKS_KEY_CTRL_L;
        break;
    case 0x15U:
        shortcut = CLKS_KEY_CTRL_U;
        break;
    case 0x17U:
        shortcut = CLKS_KEY_CTRL_W;
        break;
    case 0x04U:
        shortcut = CLKS_KEY_CTRL_D;
        break;
    case 0x1EU:
